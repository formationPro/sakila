...
/**
 * NicerButSlowerFilmListId created by Yassine
 */
public class NicerButSlowerFilmListId  implements java.io.Serializable {
    ...
    public NicerButSlowerFilmListId(Short fid, String title, String description, String category, BigDecimal price, Short length, String rating, String actors) {
       this.fid = fid;
       this.title = title;
